...
_CFGS = {
    "cpubone_nano": dict(
        width_list=[12, 24, 48, 96, 192], depth_list=[0, 1, 1, 1, 2], head_widths=(768, 1024)
    ),
    "cpubone_t0": dict(
        width_list=[12, 24, 48, 96, 192], depth_list=[0, 1, 1, 2, 3], head_widths=(768, 1024)
    ),
    "cpubone_s0": dict(
        width_list=[14, 28, 56, 112, 224], depth_list=[0, 1, 1, 2, 3], head_widths=(1024, 1280)
    ),
    "cpubone_b0_bfrobust": dict(
        width_list=[16, 32, 64, 128, 256], depth_list=[0, 1, 1, 3, 4], head_widths=(1280, 1536)
    ),
    "cpubone_b1_bfrobust": dict(
        width_list=[20, 40, 80, 160, 320], depth_list=[0, 1, 1, 6, 6], head_widths=(2304, 2560)
    ),
    "cpubone_b1_dwnorm": dict(
        width_list=[20, 40, 80, 160, 320], depth_list=[0, 1, 1, 6, 6], head_widths=(2304, 2560)
    ),
    ...
    "cpubone_b3": dict(
        width_list=[32, 64, 128, 256, 512], depth_list=[1, 2, 3, 6, 6], head_widths=(2560, 2816)
    ),
}
