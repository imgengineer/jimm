...
class OutlookAttention(nnx.Module):
    ...
    def __init__(
        self, dim, num_heads=6, kernel_size=3, padding=1, stride=1, qkv_bias=False, *, rngs
    ):
    ...
    def __init__(
        ...
        *,
        ...
        self.stage1 = nnx.List(
            [
                Outlooker(
                    embed_dims[0], num_heads[0], mlp_ratio=mlp_ratio, drop_path=dpr[i], rngs=rngs
                )
        ...
        self.stage2 = nnx.List(
            [
                TransformerBlock(
                    embed_dims[1], num_heads[1], mlp_ratio=4.0, drop_path=dpr[k + i], rngs=rngs
                )
