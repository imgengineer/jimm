...
LARGE_CFG = [
    ...
    (5, 3, 40, 40, 1, "relu", 1),
    (5, 3, 40, 40, 1, "relu", 1),
    (3, 6, 40, 80, 0, "hswish", 2),
    (3, 2.5, 80, 80, 0, "hswish", 1),
    (3, 2.3, 80, 80, 0, "hswish", 1),
    (3, 2.3, 80, 80, 0, "hswish", 1),
    (3, 6, 80, 112, 1, "hswish", 1),
    (3, 6, 112, 112, 1, "hswish", 1),
    (5, 6, 112, 160, 1, "hswish", 2),
    (5, 6, 160, 160, 1, "hswish", 1),
    (5, 6, 160, 160, 1, "hswish", 1),
]
SMALL_CFG = [
    (3, 1, 16, 16, 1, "relu", 2),
    (3, 4.5, 16, 24, 0, "relu", 2),
    (3, 3.67, 24, 24, 0, "relu", 1),
    (5, 4, 24, 40, 1, "hswish", 2),
    (5, 6, 40, 40, 1, "hswish", 1),
    (5, 6, 40, 40, 1, "hswish", 1),
    (5, 3, 40, 48, 1, "hswish", 1),
    (5, 3, 48, 48, 1, "hswish", 1),
    (5, 6, 48, 96, 1, "hswish", 2),
    (5, 6, 96, 96, 1, "hswish", 1),
    (5, 6, 96, 96, 1, "hswish", 1),
]
